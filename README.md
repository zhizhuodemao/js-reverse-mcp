...
[Bloome](https://bloome.im/login?ref=zhizhuodemao) 让 Claude、ChatGPT、DeepSeek 等多个 AI agent 在同一个云端对话里协作。做 JS 逆向调试时，可以直接在网页或手机上使用，零配置运行，还能把配好的 agent 分享给团队。
